...
export default function UserDetailsPage() {
  ...
  console.log(enrollments,"enrollments from user data")
    ...
    // }, 0) || 0;
      const totalPaymentAmount = userData?.totalEnrollmentAmount || 0;
    ...
    //   0
    //   ) || 0;
    const totalDiscount: string = ((userData?.totalEnrollCourseOriginalPrice-userData?.totalEnrollmentAmount).toFixed(2)) || "0";
