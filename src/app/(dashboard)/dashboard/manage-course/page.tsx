                      ...
                      {resources.map((resource: Resource) => (
                        ...
                        >
                          ...
                          <div className="p-4 sm:p-6 flex flex-col flex-grow">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 pt-4 sm:pt-6 mt-auto">
                              <Link
                              ...
                              <button
                                ...
                                className="p-2 sm:p-3 hover:text-black bg-green-100 text-black hover:bg-[#379a36] rounded-full transition-colors cursor-pointer duration-200"
                              >
                                <Trash2 className="w-3 h-3 sm:w-4 sm:h-4" />
                              </button>
                            </div>
